        ...
        <div className="relative rounded-2xl overflow-hidden border border-blue-600/60 shadow-2xl">
          ...
          <div className="hidden md:flex absolute inset-0 bg-black/40 items-center justify-center text-center px-6">
            <div className="max-w-3xl">
              ...
              >
                Build your online store with our expert e-commerce development
                services. We create seamless shopping experiences that drive
                sales and customer loyalty. From custom storefronts to secure
                payment integrations, we have you covered.
              </motion.p>
            </div>
          </div>
        </div>
