    ...
    <section className="min-h-[100dvh] lg:h-screen w-full pt-6 pb-12 px-4 sm:px-6 bg-[#040A15] flex items-start justify-center">
      <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between gap-4">
        ...
        >
          ...
          >
            <span className="text-[#1374BB]">Dedicated</span>
            <br />
            Developers for
            <br />
            Your Projects
          ...
          >
            ...
            with expertise in web, mobile, and software solutions. Our dedicated
            developers work exclusively on your projects, ensuring seamless
            integration and high-quality deliverables.
          </motion.p>
