    ...
    <section className="min-h-[100dvh] lg:h-screen w-full pt-6 pb-12 px-4 sm:px-6 bg-[#040A15] flex items-start justify-center">
      <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between gap-4">
        ...
        >
          ...
          >
            Our web application development services deliver powerful, scalable,
            and user-friendly solutions tailored to your business needs. We
            specialize in creating custom web applications that enhance user
            experiences and drive business growth. From responsive design to
            robust backend development, we ensure your web application stands
