...
export default function About() {
  return (
    <main className="bg-[#030712] text-white overflow-hidden selection:bg-cyan-500/30 font-sans">
      ...
      {/* --- HERO SECTION (Modern Split Layout with Video) --- */}
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 sm:px-6 border-b border-white/10 overflow-hidden">
        {/* Background Glows (kept for that TechStrota vibe) */}
        <div className="absolute top-0 left-1/4 w-[300px] h-[300px] bg-fuchsia-600/10 blur-[120px] rounded-full pointer-events-none"></div>
        <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-cyan-600/10 blur-[120px] rounded-full pointer-events-none"></div>

        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          {/* Left Column: Text Content */}
          <div className="text-center lg:text-left space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-cyan-400 text-xs md:text-sm font-semibold uppercase tracking-widest backdrop-blur-md">
            ...
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-light max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
              <button className="px-8 py-4 bg-cyan-500 hover:bg-cyan-600 text-black font-bold rounded-2xl transition-all hover:scale-105 active:scale-95">
                Get Started
              </button>
          ...
          {/* Right Column: Featured Video with Tech Frame */}
          <div className="relative group">
            {/* Animated Border Glow behind the video */}
            <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-fuchsia-500 rounded-[2rem] blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>

            <div className="relative bg-[#030712] rounded-[1.8rem] border border-white/10 overflow-hidden shadow-2xl">
              <video
                autoPlay
                loop
                muted
              ...
              {/* Subtle Glass Overlay on the bottom of the video */}
              <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent backdrop-blur-sm">
                <p className="text-xs text-cyan-400 font-mono tracking-widest uppercase">
                  TechStrota Innovation Lab // 2026
                </p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4 md:gap-6">
              {[
                ...
                <div
                  key={idx}
                  className={`group bg-white/[0.03] backdrop-blur-xl p-8 rounded-3xl border border-white/10 transition-all duration-500 ${item.glow} hover:-translate-y-2 ${idx % 2 !== 0 ? "sm:mt-12" : ""}`}
                >
